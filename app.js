...
veryOldInventors = inventors.filter((inventor, index, inventors) => {
...
sortedByBirthYear = inventors.sort((oldInventor, youngInventor) => {
  return oldInventor.year - youngInventor.year
})
...
firstLast = people.map((person, index) => {
...
totalYearsLived = inventors.reduce((accumulator, inventor) => {
